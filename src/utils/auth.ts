...
export function extractDeviceIdFromJWT(accessToken: string): string | null {
...
export async function fetchIdentity(request: Request, env: Env, retries = 1): Promise<Response> {
